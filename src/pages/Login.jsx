// components/Login.jsx (or pages/Login.jsx - adjust import path as needed)
...
export default function Login() {
  ...
  const handleSubmit = () => {
    ...
    // Hardcoded credentials check (as per test prompt)
    if (email === "admin" && password === "pass123") {
      dispatch({ type: "LOGIN", payload: true });
      dispatch({ type: "USER_DETAILS", payload: [{ email, role: "admin" }] }); // Optional: Store user info
